...
(`garmin/monkey-beta.jungle`, formerly monkey-invite, own UUID, "WingFoil - Invite Beta") is therefore a public
...
//
// The invite-beta pepper (docs/decisions.md ADR-012). No jungle puts this since 0.9.11 (the lock is retired); monkey-invite.jungle used to put this
// directory on the source path; every jungle compiles the all-zero
