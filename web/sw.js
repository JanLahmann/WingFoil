...
const VERSION = "v68";     // v67: Apple Watch comes right after Garmin wherever watches are listed; the routes lose their letters and gain a class pill; the /start/ folds say "Show the N steps"; the site nav keeps its right gutter on a phone (v65: every rider sentence on the site is in the voice of docs/voice.md (v60: the site is cut in half — the front door keeps the card and two links, /start/ folds its routes, "How it works" becomes "What it measures", one footer everywhere; v59: the example session is a button, the analyzer gains a glossary and a feedback door; v58: the copy contract on the pages))
