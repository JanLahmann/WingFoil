...
const APP_SHELL = [
  ...
  "js/appsettings.js",
  "js/appcopy.js",
  // How much every explanation says, and the `?` that carries the rest (r7-w5). Part of
  // the shell: without it a cached page would draw its concise lines and no way to open
  // them.
  "js/explain.js",
  "js/cardmap.js",
  "js/cardstats.js",
  ...
  "js/rpc.js",
  "js/sections.js",
  // Send one session to the developer, from the Details tab's export panel. 4 KB, and it
  // is the one module here that is about a mail rather than about the page: precached
  // like the rest so an installed app can open the sheet with no network and find out
  // which route this browser has.
  "js/senddev.js",
  "js/session.js",
  "js/sharecard.js",
  "js/spots.js",                                                   // r3-w3
