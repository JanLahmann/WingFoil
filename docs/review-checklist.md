...
| **I** | Paragraphs ungoverned by the sentence rules | A rider paragraph is at most 40 words; a Settings or Import footer 25; a help summary 20. | `check_voice.py`, strict since the second voice pass; the summary and the body in `HelpBudgetTests`. Split, never compress. |
