...
public enum HelpCatalog {
    ...
    public static let topics: [HelpTopic] = [
        ...
        HelpTopic(
            ...
            summary: "A 20-minute check on land, before the wind is worth it.",
            body: [
                "The most useful twenty minutes you can spend on CleanJibe happen on land. "
                + "Record three to five minutes on your watch — a walk or a bike ride, no "
                + "wing and no wind — get it onto the phone, and see whether the session "
                + "arrives and reads the way it should.",
                "It is worth doing before your next real session, because it separates \"my "
                + "watch is not set up for this\" from \"CleanJibe read my riding wrong\" — "
                + "and those two are fixed in completely different places. A five-minute walk "
                + "has no flights and no jibes in it, and that is the point: what you are "
                + "checking is that the recording arrives at all, on the right date, at the "
                + "right place, with a track on the map.",
                "The walkthrough is a web page rather than a screen in here, because it has "
                + "to cover every way in — a Garmin through intervals.icu, a file out of your "
                + "watch's own app, a session already on Strava — and those change whenever "
                + "somebody moves a menu. It says what a working result looks like, and where "
                + "to write when it is not.",
            ],
