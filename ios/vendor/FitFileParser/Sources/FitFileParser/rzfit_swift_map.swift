...
func rzfit_swift_string_for_type(fit_type : FIT_UINT8, val : FIT_UINT32 ) -> String {
  switch fit_type {
     ...
     case 169: return rzfit_swift_string_from_favero_product( FIT_UINT16(truncatingIfNeeded: val) )
     case 170: return rzfit_swift_string_from_split_type( FIT_ENUM(truncatingIfNeeded: val) )
     case 171: return rzfit_swift_string_from_climb_pro_event( FIT_ENUM(truncatingIfNeeded: val) )
     case 172: return rzfit_swift_string_from_gas_consumption_rate_type( FIT_ENUM(truncatingIfNeeded: val) )
     case 173: return rzfit_swift_string_from_tap_sensitivity( FIT_ENUM(truncatingIfNeeded: val) )
     case 174: return rzfit_swift_string_from_radar_threat_level_type( FIT_ENUM(truncatingIfNeeded: val) )
     case 175: return rzfit_swift_string_from_max_met_speed_source( FIT_ENUM(truncatingIfNeeded: val) )
     case 176: return rzfit_swift_string_from_max_met_heart_rate_source( FIT_ENUM(truncatingIfNeeded: val) )
     case 177: return rzfit_swift_string_from_hrv_status( FIT_ENUM(truncatingIfNeeded: val) )
     case 178: return rzfit_swift_string_from_no_fly_time_mode( FIT_ENUM(truncatingIfNeeded: val) )
